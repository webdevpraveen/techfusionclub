...
var t = e(`calendar-days`, [
  ...
  r = [
    {
      ...
      summary: `The university's flagship annual tech fest: a 36-hour hackathon, Smart India Hackathon internal prep, coding arena, tech talks, and project expo.`,
      description: [
    ...
    },
    {
      ...
      summary: `Official university-wide screening & mentorship hackathon for Smart India Hackathon (SIH) problem statements.`,
      description: [
    ...
    },
    {
      ...
      summary: `Where technology meets creative arts: UI/UX design sprints, generative AI art battles, and interactive tech installations.`,
      description: [
    ...
    },
    {
      ...
      summary: `A hands-on session on retrieval, evaluation, and shipping an LLM feature that does not embarrass you in production.`,
      description: [
    ...
    },
    {
      ...
      summary: `The fifth edition of the university's flagship fest: 500+ registrations, 62 hackathon teams, 5 sponsors.`,
      description: [
  ...
  i = [`Workshop`, `Hackathon`, `Seminar`, `Competition`],
  a = Array.from(new Set(r.map((e) => e.year))).sort((e, t) => t - e),
  o = r.find((e) => e.status === `upcoming`) ?? r[0];
function s(e) {
  let t = { day: `numeric`, month: `short`, year: `numeric` },
    n = new Date(e.date);
  if (!e.endDate) return n.toLocaleDateString(`en-GB`, t);
  let r = new Date(e.endDate);
  return n.getMonth() === r.getMonth() && n.getFullYear() === r.getFullYear()
    ? `${n.getDate()}–${r.toLocaleDateString(`en-GB`, t)}`
    : `${n.toLocaleDateString(`en-GB`, t)} – ${r.toLocaleDateString(`en-GB`, t)}`;
}
export { s as a, o as i, a as n, n as o, r, t as s, i as t };
