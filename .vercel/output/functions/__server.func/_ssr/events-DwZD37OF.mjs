//#region node_modules/.nitro/vite/services/ssr/assets/events-DwZD37OF.js
var events = [
  {
    slug: "viveka-6-0",
    ...
    winners: [
      {
        position: "1st",
        name: "Team Overclock",
        project: "Campus accessibility mapper",
      },
      {
        position: "2nd",
        name: "Team Latency",
        project: "Real-time lab equipment tracker",
      },
      {
        position: "3rd",
...
var eventCategories = ["Workshop", "Hackathon", "Seminar", "Competition"];
var eventYears = Array.from(new Set(events.map((e) => e.year))).sort((a, b) => b - a);
var featuredEvent = events.find((e) => e.status === "upcoming") ?? events[0];
...
//#endregion
export {
  formatEventDate as a,
  featuredEvent as i,
  eventYears as n,
  events as r,
  eventCategories as t,
};
